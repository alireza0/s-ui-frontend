export default {
  ...
  client: {
    ...
    resetDays: "Khoảng cách (ngày)",
    resetType: "Lịch tự động đặt lại",
    resetTypePeriodic: "Mỗi N ngày",
    resetTypeDaily: "Hằng ngày vào giờ cố định",
    resetTypeWeekly: "Hằng tuần vào ngày cố định",
    resetTypeMonthly: "Hằng tháng vào ngày cố định",
    resetHour: "Thời gian đặt lại (giờ)",
    resetWeekDay: "Ngày đặt lại trong tuần",
    resetMonthDay: "Ngày đặt lại trong tháng",
    weekDaySun: "Chủ nhật",
    weekDayMon: "Thứ hai",
    weekDayTue: "Thứ ba",
    weekDayWed: "Thứ tư",
    ...
    weekDayFri: "Thứ sáu",
    weekDaySat: "Thứ bảy",
    nextReset: "Thời gian đặt lại tiếp theo",
  },
  bulk: {
    order: "Sắp xếp",
    random: "Ngẫu nhiên",
