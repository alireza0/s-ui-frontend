export default {
  ...
  client: {
    ...
    resetDays: "فاصله (روز)",
    resetType: "زمان‌بندی بازنشانی خودکار",
    resetTypePeriodic: "هر N روز",
    resetTypeDaily: "روزانه در زمان مشخص",
    resetTypeWeekly: "هفتگی در روز مشخص",
    resetTypeMonthly: "ماهانه در تاریخ مشخص",
    resetHour: "زمان بازنشانی (ساعت)",
    resetWeekDay: "روز بازنشانی در هفته",
    resetMonthDay: "روز بازنشانی در ماه",
    weekDaySun: "یکشنبه",
    weekDayMon: "دوشنبه",
    weekDayTue: "سه‌شنبه",
    weekDayWed: "چهارشنبه",
