export default {
  ...
  client: {
    ...
    resetDays: "Interval (Days)",
    resetType: "Auto Reset Schedule",
    resetTypePeriodic: "Every N Days",
    resetTypeDaily: "Daily at a Fixed Time",
    resetTypeWeekly: "Weekly on a Fixed Day",
    resetTypeMonthly: "Monthly on a Fixed Date",
    resetHour: "Reset Time (Hour)",
    resetWeekDay: "Reset Day of Week",
    resetMonthDay: "Reset Day of Month",
    weekDaySun: "Sunday",
    weekDayMon: "Monday",
    weekDayTue: "Tuesday",
